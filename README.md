...
@Override
 protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
     ...
     if (requestCode == PAY_ACTIVITY_REQUEST) {
         ...
         if(data != null && data.hasExtra(PSPHOSTActivity.DATA_INTENT_SESSION_INTERRUPTED)) {
             String token = data.getStringExtra(PSPHOSTActivity.DATA_INTENT_SESSION_INTERRUPTED);
         }
     }
 }
```
